...
export class ChatService {
  ...
  // private socket = io('https://chat-server-git-main-sks-projects-e9394d4c.vercel.app/'); // WebSocket server URL
  private socket = io('https://chat-server-git-main-sks-projects-e9394d4c.vercel.app/', {
    transports: ['websocket', 'polling']
  });
  private apiUrl = 'https://chat-server-git-main-sks-projects-e9394d4c.vercel.app/messages'; // HTTP API endpoint to fetch messages
